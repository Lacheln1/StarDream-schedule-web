...
export const UreiSchedule: StreamerSchedule = {
    ...
    tue: [{ todo: "게임", time: "19:00" }],
    wed: [{ todo: "게임", time: "19:00" }],
...
export const OnhayanSchedule: StreamerSchedule = {
    mon: [{ todo: "on챗", time: "08:00" }],
    tue: [{ todo: "OFFLINE", time: "" }],
    wed: [{ todo: "언더테일", time: "14:00" }],
    thu: [{ todo: "클로버핏", time: "20:00" }],
...
export const HanabinSchedule: StreamerSchedule = {
    ...
    thu: [{ todo: "MBTI 재검사 + 나빈 사용법", time: "21:00" }],
...
export const IruneSchedule: StreamerSchedule = {
    ...
    tue: [{ todo: "N/S 토론", time: "16:00" }],
    wed: [{ todo: "클러버 핏", time: "16:00" }],
    thu: [{ todo: "버튜버 종족 맞추기 + 마추기아이오", time: "16:00" }],
